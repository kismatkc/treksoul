...
//   useEffect(() => {
//     ;(async function () {
//       const data: any = await axios.get('/api/treks')

//       const trekNames = data.data.docs.map((trek: any) => trek.name)
//       setTreks(trekNames)
//     })()
//   }, [])
...
//     if (isMobile) window.location.href = gmailApp
//     else window.open(gmailWeb, '_blank', 'noopener,noreferrer')
//   }
...
//           className="z-[100] my-4 cursor-pointer bg-[color:var(--book-now-button-color)] p-6 text-lg font-bold hover:bg-[color:var(--book-now-button-color)] hover:scale-105 transition-all"
//           onClick={(e) => {
//             e.stopPropagation()
//           }}
//         >
