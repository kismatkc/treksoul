...
const TrekCard = ({ trek, treksSetting }: { trek: Trek; treksSetting: TreksPage }) => {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-xl shadow-lg transition border-[.3px] border-gray-300 px-4 ">
      ...
      >
        ...
        <Button className=" my-4 text-lg font-bold p-6 bg-[color:var(--trek-card-right-color)]">
