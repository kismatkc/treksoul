...
import { Media, Trek } from '@/payload-types'
    ...
    <div className="px-6">
      <div className="relative w-full overflow-hidden rounded-xl shadow-lg transition border-[.3px] border-gray-300">
        ...
        <div className="flex items-center  justify-around mb-2">
          <Button className="bg-[#00807A] my-4 text-lg font-bold p-6">Learn more</Button>
          <Button className="bg-[#00807A] my-4 text-lg font-bold p-6">Book now</Button>
        </div>
      </div>
    </div>
  )
