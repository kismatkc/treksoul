...
const FooterConfig: GlobalConfig = {
  ...
  fields: [
    ...
    /* SOCIAL ----------------------------------------------- */
    {
      ...
      type: 'group',
      fields: [
        { name: 'facebook', label: 'Facebook URL', type: 'text', defaultValue: 'https://facebook.com/' },
        { name: 'instagram', label: 'Instagram URL', type: 'text', defaultValue: 'https://instagram.com/' },
        { name: 'whatsapp', label: 'WhatsApp URL', type: 'text', defaultValue: 'https://wa.me/0000000000' },
      ],
    },

    /* COLOURS ---------------------------------------------- */
    { name: 'accent_color', label: 'Accent Colour', type: 'text', defaultValue: '#047857' },
    { name: 'hover_bg_color', label: 'Icon Hover Background', type: 'text', defaultValue: '#d1fae5' },
    ...
    /* COPYRIGHT -------------------------------------------- */
    { name: 'copyright_name', label: 'Copyright Name', type: 'text', defaultValue: 'TrekSoulNepal' },
  ],
};
